...
load_dotenv(BASE_DIR / ".env") # Load .env file here
...
SECRET_KEY = os.getenv("SECRET_KEY", 'django-insecure-#2i8yvhj-^vqwf99q0&8)@fw4xwo9+m6=rr^e1-7s_funa*$)v')
